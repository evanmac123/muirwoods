...
<section class="home__split" >
	<div class="row expanded large-collapsed">
			<a href="<?php the_field("home-split-left-link"); ?>" class="large-6 column home__split-column" style="background-image:url('<?php the_field("home-split-right-background-img");?>')">
					<div class="home__split-title"><?php the_field("home-split-left-title"); ?></div>
						<div class="home__split-description"><?php the_field("home-split-left-description"); ?></div>
			</a>
			<a href="<?php the_field("home-split-right-link"); ?>" class="large-6 column  home__split-column" style="background-image:url('<?php the_field("home-split-left-background-img");?>')">
				<div class="home__split-title"><?php the_field("home-split-right-title"); ?></div>
					<div class="home__split-description"><?php the_field("home-split-right-description"); ?></div>
			</a>
</div>
</section>
...
<section class="home__videos" style="background-image:url('<?php the_field("home-videos-background-img"); ?> ');">
	<div class="main-wrap">
			...
			<p class="home__videos-description column large-6"> <?php the_field("home-videos-description"); ?> </p>
		...
		<a class="button-green" href="<?php the_field("home-videos-button"); ?>"><?php the_field("home-videos-button-text"); ?></a>
</div>
</section>
...
<section class=" home__insurance" style="background-image:url('<?php the_field("home-insurance-background-img"); ?>');">
	<div class="column large-6 small-centered">
			...
			<div class="row">
				<p class="home__insurance-description"> <?php the_field("home-insurance-description"); ?> </p>
			</div>
			<div class="home__insurance-button"><?php the_field("home-insurance-button"); ?></div>
			<img src="<?php the_field('home-insurance-logo');?>"/>
			<div class="home__insurance-logo-description column large-10 small-centered"><?php the_field('home-insurance-logo-description');?></div>
	</div>
</section>
